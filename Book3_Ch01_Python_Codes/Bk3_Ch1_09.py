...
print(f"A_first_col: {A_first_col}")
print(f"A_first_col_V2: {A_first_col_V2}")
print(f"A_first_second_col_V2: {A_first_second_col_V2}")
print(f"A_first_third_col_V2: {A_first_third_col_V2}")
print(f"A_first_row: {A_first_row}")
print(f"A_second_row: {A_second_row}")
print(f"A_second_row_first_col: {A_second_row_first_col}")
